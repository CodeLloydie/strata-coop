...
import { RoleFormData, Permission, Role } from "@/models/Role";
...
export function EditRoleModal({ isOpen, onClose, onSubmit, role, availablePermissions }: EditRoleModalProps) {
